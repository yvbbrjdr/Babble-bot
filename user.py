...
START_MESSAGE = """Welcome to Babble ( @sdbhhl_bot )! Babble is a bot to help you obfuscate your words. Send me plain messages to obfuscate them, or send me obfuscated messages to restore them. You can use /setkey and /setbase to set the encryption key and Hanzi base.

Usage:
/setkey [newkey] - Set the encryption key to the specified new key or empty.
/setbase [newbase] - Set the Hanzi base to the specified new base or the default one."""
